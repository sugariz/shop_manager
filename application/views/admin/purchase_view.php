<section class="purchase-menu">
    <div class="container">
        <div class="col-12">
            <ul class="nav nav-tabs">
                <li class="nav-item">
                    <a class="nav-link active" data-toggle="tab" href="#abc">ABC</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" data-toggle="tab" href="#xyz">XYZ</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" data-toggle="tab" href="#123">123</a>
                </li>
            </ul>
            <div class="tab-content">
                <div id="abc" class="tab-pane active"><br>
                ...
                <div id="xyz" href="/shop_manager/ManagerProduct" class="container tab-pane fade"><br>
